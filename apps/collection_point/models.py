...
class CollectionPoint(models.Model):
    address = models.CharField(max_length=10000, verbose_name='Адрес точки сбора')
    description = models.TextField(max_length=10000, verbose_name='Комментарий для туриста')
