...
class Included(models.Model):
    included = models.CharField(max_length=300, verbose_name='Включено в стоимость тура')
...
class NotIncluded(models.Model):
    not_included = models.CharField(max_length=300, verbose_name='Не включено в стоимость тура')
    tour = models.ForeignKey(
        to=Tour,
        on_delete=models.CASCADE,
